...
public class Rack_Register extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                .addGap(36, 36, 36)
                .addComponent(ADD_RECORD, javax.swing.GroupLayout.PREFERRED_SIZE, 156, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(58, 58, 58)
                .addComponent(UPDATE_DELETE, javax.swing.GroupLayout.PREFERRED_SIZE, 189, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(65, 65, 65)
                .addComponent(REFRESH_BTN, javax.swing.GroupLayout.PREFERRED_SIZE, 156, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(82, 82, 82)
                .addComponent(BACK_TOMENU, javax.swing.GroupLayout.PREFERRED_SIZE, 189, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void ADD_RECORDActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ADD_RECORDActionPerformed
        try {
            Connection con = DriverManager.getConnection(link,username,pass);
            PreparedStatement pst = con.prepareStatement("INSERT INTO RACK(ID,RACK_NAME,SUBRACK,ITEM1,ITEM2,ITEM3,ITEM4,ITEM5,ITEM6,ITEM7,ITEM8,ITEM9,ITEM10) values(?,?,?,?,?,?,?,?,?,?,?,?,?)");
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(Rack_Register.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
