...
public void Fetch(){
    ...
    private void initComponents() {
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addGap(24, 24, 24)
                .addComponent(ADD_RECORD, javax.swing.GroupLayout.PREFERRED_SIZE, 190, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(46, 46, 46)
    ...
    private void ADD_RECORDActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ADD_RECORDActionPerformed
        try{
            Connection con = DriverManager.getConnection(link,username,pass);
            PreparedStatement pst = con.prepareStatement("insert into Warehouse(ID,WR_NAME,OWNER,ADDRESS,TELEPHONE,MOBILE1,MOBILE2,EMAIL,AADHAR) values(?,?,?,?,?,?,?,?,?)");
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(Warehouse_Register.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
