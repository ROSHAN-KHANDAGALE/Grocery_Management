...
public class BILL_REPORT extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "BILL GENERATION", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Monospaced", 1, 18), new java.awt.Color(255, 255, 255))); // NOI18N
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(FROMDATE, javax.swing.GroupLayout.PREFERRED_SIZE, 114, javax.swing.GroupLayout.PREFERRED_SIZE)
            ...
            .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(jPanel3Layout.createSequentialGroup()
                    ...
                    .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        .addComponent(TIME17, javax.swing.GroupLayout.DEFAULT_SIZE, 133, Short.MAX_VALUE)
                        .addComponent(DATE17, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
    ...
    private void SEARCHActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SEARCHActionPerformed
        try{
            ...
            PreparedStatement pst = conn.prepareStatement("SELECT * from billrecord where _DATE_ like '"+ FROMDATE.getText()+"%'");
    ...
    private void FROMDATEActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_FROMDATEActionPerformed
        try{
            Connection conn = DriverManager.getConnection(link,users,pass);
            PreparedStatement pst = conn.prepareStatement("SELECT _DATE_ from billrecord where _DATE_ like '" + FROMDATE.getText()+ "%'");
            ResultSet rs = pst.executeQuery();
            if(rs.next()){
